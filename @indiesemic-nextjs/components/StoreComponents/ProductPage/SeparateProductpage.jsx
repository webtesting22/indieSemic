...
const SeparateProductPage = () => {
  const { products, addToCart, cartItems, fetchProducts } =
    ...
    const fetchProductDetails = async () => {
      try {
        const response = await fetch(
          `${apibaseUrl}/indieSemic/getAllProducts?id=${id}`
        );
    ...
    <section id="ProductSeparatePage" className="enhanced-product-page">
      {relatedVariants && relatedVariants.length > 0 && (
        <>
          ...
          <div
            className={`variant-suggestion-wrapper ${
          ...
          >
            ...
            <div className="variant-list">
              {(() => {
                ...
                const filteredVariants = relatedVariants.filter(
                  (variant) =>
                    isCurrentEVK
                ...
                console.log(
                  "Filtered variants to show:",
                  filteredVariants.map((v) => v.title)
                );
      ...
      <div className="product-container">
        ...
        <div className="breadcrumb-section">
          <div className="breadcrumb-content">
            <span>
              <Link href="/iot-modules" className="breadcrumb-link">
                All Products
              </Link>
                ...
                <div className="price-container">
                  ...
                  <div className="price-info">
                    ...
                    <span className="savings">
                      You save ₹{product.price + 100 - product.price}
                    </span>
                  </div>
                </div>
                <br />
                  ...
                  <div className="action-buttons-section">
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center" }}>
                        <button
                          onClick={() => {
                            const maxQuantity = product?.title?.startsWith(
                              "EVK"
                            )
                              ? 10
                              : 20;
                      ...
                      <div style={{ fontSize: "12px", color: "#8c8c8c" }}>
                        Max quantity:{" "}
                        {product?.title?.startsWith("EVK") ? "10" : "20"}
                      </div>
                    </div>
                  ...
                  tab.content && (
                    ...
                    >
                      {tab.key === "1" ? (
                        ...
                        <div
                          className="TabDescriptionContainer"
                          style={{ display: "flex", justifyContent: "center" }}
                        >
                          <div
                            className="spec-html-table"
                            dangerouslySetInnerHTML={{
                              __html: tab.content.join(""),
                            }}
                          />
                        </div>
                            ...
                            {tab.content.map((item, idx) => {
                              if (item.type === "image") {
                                return (
                                  <div
                                    key={idx}
                                    className="pinlayout-image-container"
                                  >
                                    <img
                                      src={item.value}
                                      alt={`pin-layout-${idx}`}
                        ...
                        <div className="TabDescriptionContainer">
                          <div className="downloads-list">
                            {product.tabs.downloadsDocuments.map(
                              (download, idx) => (
                                <div
                                  key={idx}
