                ...
                <div>
                    <div className="footerLogoContainer">
                        <div style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                            <Link to="/"><img src="/Images/FooterFinalLogo.png" alt="Logo" /></Link>
                            <div className="mobileOnlyLogo">
                                <img src="/Images/MakeInIndia2.png" />
                            </div>
                        </div>
                        <div>
                            <p><b>IndieSemiC Private Limited</b></p>
                    ...
                    <Col lg={4} md={24} xs={24}>
                        <div className="SocialMediaLinks">
                            ...
                            <div className="footerSocialIcons">
                                ...
                                <div><Link to="tel:917600460240"><PhoneIcon sx={{ color: "rgb(74, 144, 226)" }} />+917600460240</Link></div>
                            </div>
                        </div>
                    </Col>
