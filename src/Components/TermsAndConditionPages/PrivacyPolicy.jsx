        ...
        <>
            <div className="section_Padding">
                ...
                <div>
                    ...
                    <p><b>Last updated on May 21st 2025</b></p>
                    <p>This privacy policy sets out how INDIESEMIC PRIVATE LIMITED uses and protects any information that you give INDIESEMIC PRIVATE LIMITED when you visit their website and/or agree to purchase from them.</p>
                    <p>INDIESEMIC PRIVATE LIMITED is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.</p>
                    <p>INDIESEMIC PRIVATE LIMITED may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you adhere to these changes.</p>
                    ...
                    <p>We use traffic log cookies to identify which pages are being used. This helps us analyze data about webpage traffic and improve our website in order to tailor it to customer needs. We only use this information for statistical analysis purposes and then the data is removed from the system.
