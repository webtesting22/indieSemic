...
const IndieSemicProduct = () => {
  ...
  }, [imageList.length]); // Add imageList.length as dependency for safety
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  ); // This removes null, undefined, or empty categories
  ...
  const SidebarContent = () => (
    <div className="left-sidebar">
      ...
      <ul className="category-list">
        <li
          className={
            selectedCategory === "All Products" ? "active-category" : ""
          }
          ...
          <div className="hero-content">
            <div className="hero-text-wrapper">
              ...
              <p className="hero-subtitle">
                Crafting semiconductors for flawless performance.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="categories-list">
                <div
                  className={`category-option ${
                    selectedCategory === "All Products" ? "active" : ""
                  }`}
                  onClick={() => handleCategoryChange("All Products")}
                >
                ...
                {categories.map((category) => {
                  const categoryCount = productList.filter(
                    (p) =>
