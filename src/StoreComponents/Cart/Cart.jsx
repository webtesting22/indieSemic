...
import { Button, Drawer, Typography, Card, InputNumber, Divider, message, Modal, Tag } from "antd";
        ...
        try {
            ...
            const options = {
                ...
                handler: async function (response) {
                    ...
                    try {
                        const fetchResponse = await fetch(`${apibaseUrl}/indiesemic/getAllPurchaseVerificationData`);
